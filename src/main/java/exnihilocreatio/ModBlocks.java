...
public class ModBlocks {
    ...
    public static final BlockBase pseudoBedrock  = Loader.isModLoaded("enderio") ? (BlockBase) new BlockBase(Material.ROCK, "block_pseudo_bedrock").setHardness(100.0F) : null;
